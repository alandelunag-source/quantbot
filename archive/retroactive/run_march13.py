"""Retroactive March 13 session runner — fetches 1-min intraday, runs open/midday/close."""
...
TICKERS = [
    # Currently held (from state files as of March 12)
...
PRICE_JSON = 'state/intraday_prices_2026-03-13.json'
DATE_STR   = '2026-03-13'
...
if not os.path.exists(PRICE_JSON):
    ...
    sys.stdout.flush()
    raw = yf.download(TICKERS, start=DATE_STR, end='2026-03-14',
