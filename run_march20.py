"""Retroactive March 20 session runner — fetches 1-min intraday, runs open/midday/close."""
...
TICKERS = [
    # Currently held (from state files as of March 19 close)
    "C","CIEN","DBC","EA","FE","FIX","GLD","GOOG","GOOGL",
    "HOLX","HWM","IEMG","IWM","JNJ","LRCX","MSFT","MU","NEM",
    "SHY","SNDK","SPY","STX","TER","UUP","WBD","WDC","WFC",
    # Likely new signals
    "AME","AXP","CCL","COO","FCX","FDX","GEV","GLW","IFF","KR","L","LII","LUV",
    "MCHP","NRG","NTAP","PG","PH","PPG","PRU","PWR","QQQ",
    "RTX","TFC","TLT","TSLA","UAL","UHS","V","XLB","XLE","XLF","XLI","XLK",
    "XLP","XLU","XLV","XLY","VXX",
]

PRICE_JSON = 'state/intraday_prices_2026-03-20.json'
DATE_STR   = '2026-03-20'
...
if not os.path.exists(PRICE_JSON):
    ...
    sys.stdout.flush()
    raw = yf.download(TICKERS, start=DATE_STR, end='2026-03-21',
...
if not any_trade:
    print("\n  No trades executed on March 20.")
