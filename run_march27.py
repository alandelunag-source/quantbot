"""Retroactive March 27 session runner — fetches 1-min intraday, runs open/midday/close."""
...
# ─── Ticker universe ──────────────────────────────────────────────────────────
TICKERS = sorted(set([
    # Currently held (from state files as of March 26 close)
    "C","DBC","GLD","GOOGL","IEMG","IWM","MSFT","SHY","SPY","UUP",
    # Likely new signals
    "AME","AXP","CCL","CIEN","COO","EA","FCX","FDX","FE","FIX","GEV","GLW","GOOG",
    "HWM","HOLX","IFF","JNJ","KR","L","LII","LRCX","LUV","MCHP","MU","NEM","NRG",
    "NTAP","PG","PH","PPG","PRU","PWR","QQQ","RTX","SNDK","STX","TER","TFC","TLT",
    "TSLA","UAL","UHS","V","WBD","WDC","WFC","XLB","XLE","XLF","XLI","XLK",
    "XLP","XLU","XLV","XLY","VXX",
]))

PRICE_JSON = 'state/intraday_prices_2026-03-27.json'
DATE_STR   = '2026-03-27'
...
if not os.path.exists(PRICE_JSON):
    ...
    sys.stdout.flush()
    raw = yf.download(TICKERS, start=DATE_STR, end='2026-03-28',
...
if not any_trade:
    print("\n  No trades executed on March 27.")
